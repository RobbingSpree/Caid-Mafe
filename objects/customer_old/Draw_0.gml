...
if show_stats
{
	...
	draw_text(x1+marg,y1+marg+row*3,"Countdown: " + string(countdown));
	draw_text(x1+marg,y1+marg+row*4,"State: " + state);
	draw_text(x1+marg,y1+marg+row*5,"Doneness: " + string(done));
	draw_text(x1+marg,y1+marg+row*6,"Y Dest: " + string(goto_y));
	draw_set_font(-1);
